# app/userstorys/catalog_story.py
from typing import List, Optional
from fastapi import HTTPException

from app.infra.api.response import Response
from app.interfaces.database.unit_of_work import IUnitOfWork
from app.interfaces.userstorys.catalog_story import ICatalogStory
from app.models.data_base.onbaording_models import (
    CountryCatalogModel, 
    DocumentTypeModel, 
    RiskLevelCatalogModel, 
    VerificationStatusModel
)
from app.models.response.catalog_response import (
    CountryResponseDTO,
